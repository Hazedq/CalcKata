public enum RimskieChisla {
    ...
    int rChislo;
    RimskieChisla(int rChislo) {
        this.rChislo = rChislo;
    }
    int getRChislo() {
        return rChislo;
    }
    static String getRim(String arab) throws CalculatorException {
        for (RimskieChisla i : values()) {
            if (Integer.toString(i.getRChislo()).equals(arab)) {
